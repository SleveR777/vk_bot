...
module.exports = function(username) {
    const bot = mineflayer.createBot({'host': 'mc.mstnw.net', 'username': username, 'version': '1.12.2', viewDistance: 'normal', plugins: {
    conversions: true,
    furnace: false,
    math: false,
    painting: false,
...
bot.on('death', function() {
    console.log(chalk.red('Бот умер(('))
    bot.quit
})
